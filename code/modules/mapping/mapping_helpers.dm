...
/obj/effect/mapping_helpers/atom_injector/custom_sound
	...
	///This should return raw sound in response to http get request. For example: "https://github.com/Ariadne-42/Gameserver/blob/master/sound/misc/bang.ogg?raw=true"
	var/sound_url
